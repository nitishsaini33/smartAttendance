...
import { SkeletonStatCards, SkeletonChart, SkeletonList } from '../common/Skeleton';
...
const Dashboard = () => {
    ...
    if (loading) return null; // skeletons render inline below
    ...
    return (
        <div className="space-y-6 page-enter">
            ...
            {/* Recent attendance — skeleton while loading */}
            {loading ? (
                <Card className="p-6">
                    <div className="skeleton-shimmer h-5 w-40 rounded-lg mb-4" />
                    <SkeletonList rows={5} />
                </Card>
            ) : (
                <Card className="p-6">
